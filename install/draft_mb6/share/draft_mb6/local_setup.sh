...
: ${AMENT_CURRENT_PREFIX:="/root/mb6-space/install/draft_mb6"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/draft_mb6/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/draft_mb6/environment/path.sh"
