...
{
  new (message_memory) communication_test_interfaces::msg::AuctionBid(_init);
}

void AuctionBid_fini_function(void * message_memory)
{
  auto typed_message = static_cast<communication_test_interfaces::msg::AuctionBid *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AuctionBid_message_member_array[2] = {
  {
    ...
    offsetof(communication_test_interfaces::msg::AuctionBid, robot_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(communication_test_interfaces::msg::AuctionBid, distance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AuctionBid_message_members = {
  "communication_test_interfaces::msg",  // message namespace
  "AuctionBid",  // message name
  2,  // number of fields
  sizeof(communication_test_interfaces::msg::AuctionBid),
...
get_message_type_support_handle<communication_test_interfaces::msg::AuctionBid>()
{
  return &::communication_test_interfaces::msg::rosidl_typesupport_introspection_cpp::AuctionBid_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, communication_test_interfaces, msg, AuctionBid)() {
  return &::communication_test_interfaces::msg::rosidl_typesupport_introspection_cpp::AuctionBid_message_type_support_handle;
}
