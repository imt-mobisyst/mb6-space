...
#ifndef COMMUNICATION_TEST_INTERFACES__MSG__DETAIL__AUCTION_BID__FUNCTIONS_H_
#define COMMUNICATION_TEST_INTERFACES__MSG__DETAIL__AUCTION_BID__FUNCTIONS_H_
 ...
 * calls
 * communication_test_interfaces__msg__AuctionBid__init().
...
/**
 * It calls
 * communication_test_interfaces__msg__AuctionBid__fini()
 ...
 * communication_test_interfaces__msg__AuctionBid__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * communication_test_interfaces__msg__AuctionBid__Sequence__fini()
 * on the array,
...
#endif  // COMMUNICATION_TEST_INTERFACES__MSG__DETAIL__AUCTION_BID__FUNCTIONS_H_
