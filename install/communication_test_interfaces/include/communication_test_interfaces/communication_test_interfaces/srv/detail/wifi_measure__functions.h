...
#ifndef COMMUNICATION_TEST_INTERFACES__SRV__DETAIL__WIFI_MEASURE__FUNCTIONS_H_
#define COMMUNICATION_TEST_INTERFACES__SRV__DETAIL__WIFI_MEASURE__FUNCTIONS_H_
...
#include "communication_test_interfaces/msg/rosidl_generator_c__visibility_control.h"
 ...
 * calls
 * communication_test_interfaces__srv__WifiMeasure_Request__init().
...
/**
 * It calls
 * communication_test_interfaces__srv__WifiMeasure_Request__fini()
 ...
 * communication_test_interfaces__srv__WifiMeasure_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * communication_test_interfaces__srv__WifiMeasure_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * communication_test_interfaces__srv__WifiMeasure_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_communication_test_interfaces
...
/**
 * It calls
 * communication_test_interfaces__srv__WifiMeasure_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_communication_test_interfaces
...
/**
 * It allocates the memory for the array and calls
 * communication_test_interfaces__srv__WifiMeasure_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_communication_test_interfaces
...
/**
 * It calls
 * communication_test_interfaces__srv__WifiMeasure_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * communication_test_interfaces__srv__WifiMeasure_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_communication_test_interfaces
...
/**
 * It calls
 * communication_test_interfaces__srv__WifiMeasure_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_communication_test_interfaces
...
/**
 * It allocates the memory for the array and calls
 * communication_test_interfaces__srv__WifiMeasure_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_communication_test_interfaces
...
/**
 * It calls
 * communication_test_interfaces__srv__WifiMeasure_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COMMUNICATION_TEST_INTERFACES__SRV__DETAIL__WIFI_MEASURE__FUNCTIONS_H_
