...
{
  new (message_memory) multibot_msgs::msg::Pulse(_init);
}

void Pulse_fini_function(void * message_memory)
{
  auto typed_message = static_cast<multibot_msgs::msg::Pulse *>(message_memory);
  typed_message->~Pulse();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Pulse_message_member_array[3] = {
  {
    ...
    offsetof(multibot_msgs::msg::Pulse, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(multibot_msgs::msg::Pulse, system_name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(multibot_msgs::msg::Pulse, description),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Pulse_message_members = {
  ...
  "Pulse",  // message name
  3,  // number of fields
  sizeof(multibot_msgs::msg::Pulse),
...
get_message_type_support_handle<multibot_msgs::msg::Pulse>()
{
  return &::multibot_msgs::msg::rosidl_typesupport_introspection_cpp::Pulse_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, multibot_msgs, msg, Pulse)() {
  return &::multibot_msgs::msg::rosidl_typesupport_introspection_cpp::Pulse_message_type_support_handle;
}
