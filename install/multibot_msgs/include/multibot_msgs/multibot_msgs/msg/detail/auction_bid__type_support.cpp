...
#include "multibot_msgs/msg/detail/auction_bid__struct.hpp"
...
{
  new (message_memory) multibot_msgs::msg::AuctionBid(_init);
}

void AuctionBid_fini_function(void * message_memory)
{
  auto typed_message = static_cast<multibot_msgs::msg::AuctionBid *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AuctionBid_message_member_array[2] = {
  {
    ...
    offsetof(multibot_msgs::msg::AuctionBid, robot_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(multibot_msgs::msg::AuctionBid, distance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AuctionBid_message_members = {
  "multibot_msgs::msg",  // message namespace
  "AuctionBid",  // message name
  2,  // number of fields
  sizeof(multibot_msgs::msg::AuctionBid),
...
get_message_type_support_handle<multibot_msgs::msg::AuctionBid>()
{
  return &::multibot_msgs::msg::rosidl_typesupport_introspection_cpp::AuctionBid_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, multibot_msgs, msg, AuctionBid)() {
  return &::multibot_msgs::msg::rosidl_typesupport_introspection_cpp::AuctionBid_message_type_support_handle;
}
