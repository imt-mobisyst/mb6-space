...
basic_msgs__msg__Pulse__init(basic_msgs__msg__Pulse * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    basic_msgs__msg__Pulse__fini(msg);
    return false;
  }
  // system_name
...
basic_msgs__msg__Pulse__create()
{
  ...
  basic_msgs__msg__Pulse * msg = (basic_msgs__msg__Pulse *)allocator.allocate(sizeof(basic_msgs__msg__Pulse), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(basic_msgs__msg__Pulse));
  bool success = basic_msgs__msg__Pulse__init(msg);
  if (!success) {
...
basic_msgs__msg__Pulse__Sequence__init(basic_msgs__msg__Pulse__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  basic_msgs__msg__Pulse * data = NULL;

  if (size) {
    data = (basic_msgs__msg__Pulse *)allocator.zero_allocate(size, sizeof(basic_msgs__msg__Pulse), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = basic_msgs__msg__Pulse__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        basic_msgs__msg__Pulse__fini(&data[i - 1]);
      }
...
basic_msgs__msg__Pulse__Sequence__fini(basic_msgs__msg__Pulse__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      basic_msgs__msg__Pulse__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  basic_msgs__msg__Pulse__Sequence * array = (basic_msgs__msg__Pulse__Sequence *)allocator.allocate(sizeof(basic_msgs__msg__Pulse__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = basic_msgs__msg__Pulse__Sequence__init(array, size);
  if (!success) {
...
basic_msgs__msg__Pulse__Sequence__destroy(basic_msgs__msg__Pulse__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    basic_msgs__msg__Pulse__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
basic_msgs__msg__Pulse__Sequence__are_equal(const basic_msgs__msg__Pulse__Sequence * lhs, const basic_msgs__msg__Pulse__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!basic_msgs__msg__Pulse__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  basic_msgs__msg__Pulse__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(basic_msgs__msg__Pulse);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    basic_msgs__msg__Pulse * data =
      (basic_msgs__msg__Pulse *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!basic_msgs__msg__Pulse__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          basic_msgs__msg__Pulse__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!basic_msgs__msg__Pulse__copy(
